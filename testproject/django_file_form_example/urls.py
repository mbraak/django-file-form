...
urlpatterns = (
    ...
    path("model_form/<int:pk>", views.EditModelFormView.as_view(), name="model_form_update"),
    path("model_form_multiple", views.CreateModelFormMultipleView.as_view(), name="model_form_multiple_create"),
    path("model_form_multiple/<int:pk>", views.EditModelFormMultipleView.as_view(), name="model_form_multiple_update"),
