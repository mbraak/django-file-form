(function () {
  ...
  BaseUpload$1.defaultOptions = defaultOptions$1;
  ...
  */
  ...
  var defaultOptions = _objectSpread(_objectSpread({}, BaseUpload$1.defaultOptions), {}, {
  ...
  var Upload = /*#__PURE__*/function (_BaseUpload) {
    ...
    _createClass(Upload, null, [{
      ...
      value: function terminate(url) {
        var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
        options = _objectSpread(_objectSpread({}, defaultOptions), options);
        return BaseUpload$1.terminate(url, options);
      }
    }]);
    return Upload;
  }(BaseUpload$1);
  ...
  class RenderUploadFile {
    ...
    setError(index, message) {
      this.setErrorMessage(index, message || this.translations["Upload failed"] || "");
  ...
  class BaseUploadedFile extends BaseUpload {
    constructor(_ref) {
      let {
        name,
        size,
  ...
  class TusUpload extends BaseUpload {
    constructor(_ref) {
      let {
        chunkSize,
        csrfToken,
