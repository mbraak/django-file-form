...
exports.getInputValueForFormAndPrefix = exports.getPlaceholderFieldName = exports.findInput = exports.getInputNameWithPrefix = exports.formatBytes = void 0;
...
exports.getInputNameWithPrefix = getInputNameWithPrefix;
...
exports.getPlaceholderFieldName = getPlaceholderFieldName;
...
exports.getInputValueForFormAndPrefix = getInputValueForFormAndPrefix;
...
var _upload_file = _interopRequireDefault(__webpack_require__(12));
...
var initUploadFields = function initUploadFields(form) {
  ...
  var getInputValue = function getInputValue(fieldName) {
    return (0, _util.getInputValueForFormAndPrefix)(form, fieldName, getPrefix());
  };
  ...
  var getPlaceholders = function getPlaceholders(fieldName) {
    var data = getInputValue((0, _util.getPlaceholderFieldName)(fieldName, getPrefix()));
...
var initFormSet = function initFormSet(form, optionsParam) {
  ...
  var totalFormsValue = (0, _util.getInputValueForFormAndPrefix)(form, "TOTAL_FORMS", prefix);
  ...
  for (var i = 0; i < formCount; i += 1) {
    var subFormPrefix = (0, _util.getInputNameWithPrefix)("".concat(i), null);
...
var _tusJsClient = __webpack_require__(26);

var _util = __webpack_require__(4);

var _render_upload_file = _interopRequireDefault(__webpack_require__(19));

var _drop_area = _interopRequireDefault(__webpack_require__(21));
...
var UploadFile = /*#__PURE__*/function () {
  function UploadFile(_ref) {
    ...
    (0, _defineProperty2["default"])(this, "callbacks", void 0);
    (0, _defineProperty2["default"])(this, "fieldName", void 0);
    (0, _defineProperty2["default"])(this, "form", void 0);
    (0, _defineProperty2["default"])(this, "formId", void 0);
    (0, _defineProperty2["default"])(this, "multiple", void 0);
    ...
    (0, _defineProperty2["default"])(this, "supportDropArea", void 0);
    (0, _defineProperty2["default"])(this, "uploadIndex", void 0);
    (0, _defineProperty2["default"])(this, "uploadUrl", void 0);
    (0, _defineProperty2["default"])(this, "uploads", void 0);
    (0, _defineProperty2["default"])(this, "uploadFiles", function (files) {
      if (files.length === 0) {
        return;
      }
    ...
    (0, _defineProperty2["default"])(this, "onChange", function (e) {
      _this.uploadFiles((0, _toConsumableArray2["default"])(e.target.files));
    });
    (0, _defineProperty2["default"])(this, "onClick", function (e) {
      var target = e.target;
    ...
    (0, _defineProperty2["default"])(this, "handleProgress", function (uploadIndex, bytesUploaded, bytesTotal) {
      ...
      if (onProgress) {
        ...
        if (_upload instanceof _tusJsClient.Upload) {
          onProgress(bytesUploaded, bytesTotal, _upload);
        }
      }
    });
    (0, _defineProperty2["default"])(this, "handleError", function (uploadIndex, error) {
      ...
      if (onError) {
        ...
        if (_upload2 instanceof _tusJsClient.Upload) {
          onError(error, _upload2);
        }
      }
    });
    (0, _defineProperty2["default"])(this, "handleSuccess", function (uploadIndex, uploadedSize) {
      ...
      if (onSuccess) {
        ...
        if (_upload3 instanceof _tusJsClient.Upload) {
          onSuccess(_upload3);
        }
      }
    });
    ...
    this.uploadIndex = 0;
    this.uploads = [];
    this.renderer = new _render_upload_file["default"]({
      parent: parent,
      input: input,
      skipRequired: skipRequired,
      translations: translations
  ...
  (0, _createClass2["default"])(UploadFile, [{
    ...
    value: function handleDelete(uploadIndex) {
      ...
      if (upload instanceof _tusJsClient.Upload) {
    ...
    value: function updatePlaceholderInput() {
      ...
      for (var i = 0; i < this.uploads.length; ++i) {
        ...
        if (!(_upload4 instanceof _tusJsClient.Upload) && _upload4.placeholder) {
      ...
      var input = (0, _util.findInput)(this.form, (0, _util.getPlaceholderFieldName)(this.fieldName, this.prefix), this.prefix);
...
var _escapeHtml = _interopRequireDefault(__webpack_require__(20));
...
var RenderUploadFile = /*#__PURE__*/function () {
  function RenderUploadFile(_ref) {
    var _parent = _ref.parent,
        ...
        skipRequired = _ref.skipRequired,
        translations = _ref.translations;
    (0, _classCallCheck2["default"])(this, RenderUploadFile);
    (0, _defineProperty2["default"])(this, "container", void 0);
    (0, _defineProperty2["default"])(this, "input", void 0);
    (0, _defineProperty2["default"])(this, "translations", void 0);
    (0, _defineProperty2["default"])(this, "createFilesContainer", function (parent) {
  ...
  (0, _createClass2["default"])(RenderUploadFile, [{
    key: "addUploadedFile",
    ...
    value: function addFile(filename, uploadIndex) {
      ...
      nameSpan.innerHTML = (0, _escapeHtml["default"])(filename);
    ...
    value: function setSuccess(index, size, primary) {
      ...
      if (el) {
        ...
        fileSizeInfo.innerHTML = (0, _util.formatBytes)(size, 2);
...
var _asyncIterator2 = _interopRequireDefault(__webpack_require__(25));

var getEntriesFromDirectory = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(directoryEntry) {
...
var getFileFromFileEntry = /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(fileEntry) {
...
var getFilesFromFileSystemEntries = /*#__PURE__*/function () {
  var _ref3 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(entries) {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.prev = 3;
            _iterator = (0, _asyncIterator2["default"])(entries);
...
var getFilesFromDataTransfer = /*#__PURE__*/function () {
  var _ref4 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(dataTransfer) {
    var entries, _files2;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            entries = (0, _toConsumableArray2["default"])(dataTransfer.items).map(function (item) {
          ...
          case 8:
            return _context4.abrupt("return", (0, _toConsumableArray2["default"])(dataTransfer.files));
...
var DropArea = function DropArea(_ref5) {
  ...
  (0, _defineProperty2["default"])(this, "container", void 0);
  (0, _defineProperty2["default"])(this, "onUploadFiles", void 0);
  (0, _defineProperty2["default"])(this, "onDrop", function (e) {
    var dragEvent = e;
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "Upload", function() { return /* binding */ browser_Upload; });
__webpack_require__.d(__webpack_exports__, "canStoreURLs", function() { return /* reexport */ canStoreURLs; });
__webpack_require__.d(__webpack_exports__, "defaultOptions", function() { return /* binding */ browser_defaultOptions; });
__webpack_require__.d(__webpack_exports__, "isSupported", function() { return /* binding */ isSupported; });
__webpack_require__.d(__webpack_exports__, "enableDebugLog", function() { return /* reexport */ enableDebugLog; });
...
var url_parse = __webpack_require__(9);
