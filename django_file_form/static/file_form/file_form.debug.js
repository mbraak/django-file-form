	...
	*/
	...
	var Uploads = /*#__PURE__*/function (_Component) {
	  ...
	  function Uploads(props) {
	    ...
	    defineProperty$2(assertThisInitialized(_this), "acceptedFileTypes", void 0);

	    defineProperty$2(assertThisInitialized(_this), "handleDragEnter", function () {
	      _this.setState({
	        dropping: true
	      });
	    });

	    defineProperty$2(assertThisInitialized(_this), "handleDragLeave", function () {
	      _this.setState({
	        dropping: false
	      });
	    });

	    defineProperty$2(assertThisInitialized(_this), "handleDragOver", function (e) {
	      e.preventDefault();
	    ...
	    defineProperty$2(assertThisInitialized(_this), "handleDrop", function (e) {
	      e.preventDefault();
	      e.stopPropagation();
	...
	var FileField = /*#__PURE__*/function () {
	  function FileField(_ref) {
	    ...
	    defineProperty$2(this, "skipRequired", void 0);
	    ...
	    defineProperty$2(this, "handleDelete", function (upload) {
